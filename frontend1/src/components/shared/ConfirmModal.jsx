...
const ConfirmModal = ({ isOpen, onClose, onConfirm, title, message, confirmText = 'Confirm', danger = true, isLoading = false }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md max-h-[90vh] flex flex-col bg-white rounded-xl shadow-premium overflow-hidden animate-in fade-in zoom-in-95 duration-200">
